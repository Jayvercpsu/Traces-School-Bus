      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: FutureBuilder<Map<String, dynamic>?>(
            future: _fetchDriverDetails(user.id),
            builder: (context, snapshot) {
              ...
              if (_nameCtrl.text.isEmpty) {
                ...
                _contactNumberCtrl.text = (data['contactNumber'] ?? '').toString();
                _busModelCtrl.text = (data['busModel'] ?? '').toString();
                _plateNumberCtrl.text = (data['plateNumber'] ?? '').toString();
              }

              final displayName = (data['name'] ?? 'Driver').toString();
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_isEditing)
                              ...
                              _buildInfoRow(icon: Icons.person, label: 'Full Name', value: displayName),
                            ...
                            if (_isEditing)
                              ...
                              _buildInfoRow(
                                ...
                                value: (data['contactNumber'] ?? 'N/A').toString(),
                              ),
                          ],
                        ),
                      ),
                          ...
                          children: [
                            ...
                            if (_isEditing)
                              ...
                              _buildInfoRow(
                                ...
                                label: 'Bus Model',
                                value: (data['busModel'] ?? 'N/A').toString(),
                              ),
                            const SizedBox(height: 16),
                            if (_isEditing)
                              TextFormField(
                              ...
                              _buildInfoRow(
                                ...
                                label: 'Plate Number',
                                value: (data['plateNumber'] ?? 'N/A').toString(),
                              ),
                          ],
                        ),
                      ),
